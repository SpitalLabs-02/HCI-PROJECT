  ...
  return (
    <section className=" px-8 py-12">
      <CustomCareAndRecipient
        divClassName={
          "flex flex-col items-center md:flex-col lg:flex-row gap-3 justify-between "
        }
        img={"./"}
        imgWidth={
          "w-[600px] h-[400px] md:w-[400px]   md:h-[800px]  xl:w-[600px]  lg:w-[] "
        }
        role={"For Care Givers"}
        h1={"Join Our Network of Compassionate Caregivers"}
        p={
          "As a caregiver on our platform, you'll have the opportunity to build meaningful relationships with elderly clients while advancing your career in a supportive environment."
        }
        datas={datas}
